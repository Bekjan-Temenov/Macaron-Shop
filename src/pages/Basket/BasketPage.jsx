      ...
      <section>
        <div className="rigthCon">
          <div className="first">
            <div className='value'>
              <div className="box">
                <img className='imeg' src={first} alt="" />
                <div className="texts">
                  ...
                  <p className="redText">Скидка по акции “Эклер в подарок”</p>
                </div>
                ...
                <div className="priceBoxx">
                  <p>Цена:<span className="highlight-price">950 руб.</span></p>
                  <p>Скидка:<span className="highlight-price">-30 руб.</span> </p>
                </div>
              ...
              <div className="box">
                <img src={second} alt="" />
                <div className="texts">
                  <h2 className="textH2">Упаковка с цветами</h2>
                </div>
                ...
                <div className="priceBox">
                  <p>Цена: <span className="highlight-price">50 руб.</span></p>
                </div>
                <button className="dell">del</button>
              </div>
              <hr />
              ...
              <div className="box">
                <img src={second} alt="" />
                <div className="texts">
                  <h2 className="textH2">Открытка с пожеланием</h2>
                </div>
                ...
                <div className="priceBox">
                  <p>Цена: <span className="highlight-price">30 руб.</span></p>
                </div>
                <button className="dell">del</button>
              </div>
            </div>
