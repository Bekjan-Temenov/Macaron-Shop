    ...
    <Container>
      ...
      >
        <NavLink to="/sets" style={{ textDecoration: "none" }}>
          <motion.div variants={animation} custom={1} className="usesets">
            ...
            <div className="sets-arow">
              ...
              <p>
                Готовые наборы со скидкой. Вы можете подобрать набор на
                подходящий случай.
              </p>
            </div>
          </motion.div>
        </NavLink>
        <motion.div variants={animation} custom={2} className="usesets">
          <div className="circle">
        ...
        <motion.div variants={animation} custom={3} className="usesets">
          <div className="circle">
        ...
        <motion.div variants={animation} custom={4} className="usesets">
          <div className="circle">
        ...
        <motion.div variants={animation} custom={5} className="usesets">
          ...
          <p>
            От 85 руб за шт. С уникальным дизайном. Приятный комплимент для
            коллег и партнеров
          </p>
        </motion.div>
        ...
        <motion.div variants={animation} custom={6} className="usesets">
          ...
          <p>
            Предложение для кофеен, кафе, отелей и т.д. Посмотрите условия
            сотрудничества и отзывы.
          </p>
        </motion.div>
      </motion.div>
    </Container>
